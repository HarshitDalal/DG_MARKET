...
class ProductsDetails(models.Model):
    ...
    Cateogry = models.CharField(
        max_length=50, choices=product_type_choice, default="Cloths")
    Price = models.CharField(max_length=20, blank=True)
    Discount = models.CharField(max_length=20, blank=True)
    Quantity = models.IntegerField(default=1)
    Color = models.CharField(max_length=10)
    Size = models.CharField(max_length=150)
    Small_Decription = models.TextField(
        blank=True, help_text='Describe product in 200 letters', max_length=200)
